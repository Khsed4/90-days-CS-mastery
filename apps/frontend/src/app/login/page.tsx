  ...
  return (
    <div
      style={{
        ...
        padding: '2rem',
        backgroundImage: `radial-gradient(circle at 80% 20%, rgba(99, 102, 241, 0.22), transparent 45%), radial-gradient(circle at 20% 80%, rgba(6, 182, 212, 0.2), transparent 45%), url('/images/cosmic-mesh-bg.jpg')`,
    ...
    >
      ...
      <div
        style={{
          ...
          maxWidth: '440px',
          width: '100%',
          boxShadow: '0 30px 70px -15px rgba(0, 0, 0, 0.8), 0 0 40px rgba(99, 102, 241, 0.25)',
      ...
      >
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          >
            <i className="fa-solid fa-code-branch" style={{ fontSize: '1.75rem', color: '#38bdf8' }}></i>
          </div>
          ...
          <p style={{ margin: '0.4rem 0 0 0', fontSize: '0.85rem', color: '#94a3b8' }}>
            Sign in to unlock all 90 days, bonus challenges & cloud sync
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
          ...
          >
            {submitting ? 'Authenticating...' : t.login}
          </button>
        </form>
